...
class _AlreadyHandledResponse(Response):
    ...
    try:
        ...
        # Newer Eventlet releases removed this symbol. The fallback is only
        # needed so the controller stack can import successfully for apps
        # that do not rely on this legacy WSGI return marker.
